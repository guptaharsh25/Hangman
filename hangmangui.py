...
def startgame(e, top):
	...
	man = PhotoImage(file="middle.gif")
...
## quit the game ##
def quitnow():
	tkMessageBox.showinfo("Hangman in Python, by HG", "Thanks for playing! See you soon!")
	exit()
...
def showhangman(gamelabel1, remainingguesses):
	if remainingguesses == 6:
		img = PhotoImage(file="middle.gif")
		gamelabel1.configure(image = img)
		gamelabel1.image = img
	if remainingguesses == 5:
		img = PhotoImage(file="petal1.gif")
		gamelabel1.configure(image = img)
		gamelabel1.image = img
	if remainingguesses == 4:
		img = PhotoImage(file="petal2.gif")
		gamelabel1.configure(image = img)
		gamelabel1.image = img
	if remainingguesses == 3:
		img = PhotoImage(file="petal3.gif")
		gamelabel1.configure(image = img)
		gamelabel1.image = img
	if remainingguesses == 2:
		img = PhotoImage(file="petal4.gif")
		gamelabel1.configure(image = img)
		gamelabel1.image = img
	if remainingguesses == 1:
		img = PhotoImage(file="petal5.gif")
		gamelabel1.configure(image = img)
		gamelabel1.image = img
	if remainingguesses == 0:
		img = PhotoImage(file="petal6.gif")
		gamelabel1.configure(image = img)
		gamelabel1.image = img
...
root = Tk()
root.wm_title("Hangman in Python, by HG")
